...
| Claude Marketplace: plugins and connectors, products and agents, and service partners | Claude by Anthropic | [文章](articles/claude-marketplace.md) / [原文](https://claude.com/blog/claude-marketplace) |
| Coding sessions are longer and use more context. Claude Opus 5.5 is built with that in mind. | Claude by Anthropic | [文章](articles/claude-opus-5-5-built-for-coding-sessions-that-use-more-context.md) / [原文](https://claude.com/blog/claude-opus-5-5-built-for-coding-sessions-that-use-more-context) |
| Claude Tag now supports personal connectors in channels | Claude by Anthropic | [文章](articles/claude-tag-now-supports-personal-connectors-in-channels.md) / [原文](https://claude.com/blog/claude-tag-now-supports-personal-connectors-in-channels) |
